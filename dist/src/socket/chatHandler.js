...
module.exports = (io, socket) => {
    ...
    const sendMessage = (body) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const conversationId = yield conversation_1.default.getConversation(new Request_1.default(body, socket.data.user));
    ...
    const getAllMsgById = (body) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const response = yield message_1.default.getUserMessages(new Request_1.default(body, socket.data.user), body.user);
